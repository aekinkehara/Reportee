                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="../bootstrap/bootstrap/img/undraw_profile.svg">
                            </a>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-warning">Form Tambah Feedback untuk laporan dengan ID <?= $report_id ?></h6>
                                ...
                                <div class="card-body">
                                    <form method="POST">
                                        <div class="mb-3">
                                            ...
                                            <textarea name="feedback" placeholder="Masukkan Feedback Anda" rows="3" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"></textarea>
                                        </div>
