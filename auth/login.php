                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            ...
                            <dotlottie-player src="https://lottie.host/1558769a-533c-4c3f-9180-626cb382305f/63i2FO9Is9.json" background="transparent" speed="1" style="width: 500px; height: 500px" loop autoplay></dotlottie-player>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <h3 class="h4 text-gray-900">Reportee Siap Mengatasi Keluhanmu.</h3>
                                    </div>
